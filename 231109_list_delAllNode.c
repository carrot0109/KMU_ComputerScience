...
void del_Node_rear();
void test_del_Node_rear();
void del_Node_All();
void test_del_Node_All();
...
void test_del_Node_rear() {
	...
	display();
	for (int i = 0;i < 6;i++) {
		printf("\n\t\t마지막 노드 삭제 [%d]회 실행", i + 1);
		del_Node_rear();
	}
	printf("\n\n\t\t마지막 노드를 제거 후 연결리스트는 다음과 같습니다.\n");
	display();
}
